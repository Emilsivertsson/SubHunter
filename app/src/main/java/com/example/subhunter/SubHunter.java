...
// throughout the SubHunter class
    ...
    this makes it a good place to add the code for the one-time phase
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize our sizebased variables
    ...
    /*
    This code will execute when a new game needs to be started. it will happen when the app is first started and after the player wins the game.
    */
    void newGame(){
    ...
    the gridlines, the HUD and the touch indicator and the boom when a sub is hit
     */
    void draw(){
    ...
    /*
    the code here will execute when the player taps the screen. it will calculate the distance from the sub and decide a hit och miss.
     */
